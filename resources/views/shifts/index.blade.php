        ...
        <div class="mx-auto w-full max-w-md space-y-5">
            ...
            @if (session('import-summary'))
                ...
                <div class="rounded-xl bg-sky-50 px-4 py-3 text-sm text-sky-900 ring-1 ring-sky-200">
                    <p class="font-semibold">Imported {{ $summary['imported'] }} shifts.</p>
            ...
            <div class="flex gap-2">
                <a href="{{ route('shifts.import.create') }}" class="inline-flex min-h-11 flex-1 items-center justify-center rounded-xl border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2">
                    Import
                </a>
                <a href="{{ route('shifts.export') }}" class="inline-flex min-h-11 flex-1 items-center justify-center rounded-xl bg-slate-950 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2">
                    Export
                </a>
            </div>
