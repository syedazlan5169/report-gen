    ...
    <div class="min-h-[calc(100vh-4rem)] bg-slate-50 px-4 py-6 sm:px-6 sm:py-10">
        <div class="mx-auto w-full max-w-md space-y-5">
            <div>
                ...
                <h1 class="text-2xl font-semibold tracking-tight text-slate-950">Import Shifts</h1>
            </div>
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                <form method="POST" action="{{ route('shifts.import.store') }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
